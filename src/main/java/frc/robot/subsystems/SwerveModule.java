...
public class SwerveModule {
  ...
  public SwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset, String p_moduleChannel) {
    ...
    m_drivingPIDController.setFF(0,0);
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    m_drivingPIDController.setReference((optimizedDesiredState.speedMetersPerSecond), CANSparkMax.ControlType.kVelocity, 0 ,m_drivingFeedForward.calculate(optimizedDesiredState.speedMetersPerSecond));
    m_turningPIDController.setReference(optimizedDesiredState.angle.getRadians(), CANSparkMax.ControlType.kPosition);
  ...
  public void showPID(){
    SmartDashboard.putNumber(m_moduleChannel + "P", m_drivingPIDController.getP());
    SmartDashboard.putNumber(m_moduleChannel + "I", m_drivingPIDController.getI());
    SmartDashboard.putNumber(m_moduleChannel + "D", m_drivingPIDController.getD());
    SmartDashboard.putNumber(m_moduleChannel + "FF", m_drivingPIDController.getFF());
  }
