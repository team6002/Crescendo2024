...
public class SUB_Arm extends SubsystemBase {
    ...
    /** sets the Elbow goal to its current location */
    public void resetElbow(){
        m_elbow.setGoalRad(MathUtil.clamp(getElbowPosition(), Math.toRadians(8), Math.toRadians(115)));
    }    
