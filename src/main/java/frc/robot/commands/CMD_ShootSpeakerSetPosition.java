...
public class CMD_ShootSpeakerSetPosition extends SequentialCommandGroup {
  /** Creates a new CMD_ShootSpeaker. */
  public CMD_ShootSpeakerSetPosition(
    Translation2d p_position,
    SUB_Arm p_arm,
    ...
    addCommands(
      ...
      new CMD_FireFromPosition(p_position, p_arm, p_drivetrain, p_intake, p_shooter, p_variables),
