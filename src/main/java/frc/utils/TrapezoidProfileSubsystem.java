...
public abstract class TrapezoidProfileSubsystem extends SubsystemBase {
  ...
  public final void setSetpoint(double setpoint) {
    m_state = new TrapezoidProfile.State(setpoint,0);
  }
  ...
  public void setConstraints(TrapezoidProfile.Constraints p_constraints){
    m_profile = new TrapezoidProfile(p_constraints);
  }
  /**
